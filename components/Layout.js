      ...
      {meta.sponsor && (
        <div className="bg-gray-200">
          <div className="max-w-6xl mx-auto px-6 md:px-12 xl:px-0 py-4 flex items-center justify-start overflow-x-auto">
            ...
            <a className="text-gray-600 hover:text-gray-800 mr-8" href="https://brook.io/" title="Brook">
              <svg className="w-auto h-6 fill-current" viewBox="0 0 216.01 66.49">
                <path
                  fill="#edf2f7"
            ...
            <a className="text-gray-600 hover:text-gray-800 mr-8" href="https://www.aryeo.com" title="Aryeo">
            ...
            <a className="text-gray-600 hover:text-gray-800 mr-8" href="https://www.indigit.pt/en" title="INDIGIT">
              <svg className="w-auto h-4 fill-current" viewBox="0 0 400.569 74.2" overflow="visible">
            ...
            <a className="text-gray-600 hover:text-gray-800 mr-8" href="https://contestkit.com" title="ContestKit">
