...
const components = {
  h1: ({ children }) => <h1 className="mb-8 text-5xl font-hairline text-gray-600 leading-none">{children}</h1>,
  h2: ({ children }) => <h2 className="mt-16 mb-4 text-2xl font-medium text-gray-800 leading-none">{children}</h2>,
          ...
          <div className="max-w-6xl mx-auto flex py-24">
            <nav className="w-64 flex-shrink-0">
              ...
              <ul className="mt-4">
                ...
                <li className="my-3"><Link href="/vuejs"><a className="hover:underline">Vue.js</a></Link></li>
              </ul>
