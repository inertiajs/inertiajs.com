...
const components = {
  h1: ({ children }) => <h1 className="text-5xl font-hairline text-gray-600 leading-none">{children}</h1>,
  h2: ({ children }) => <h2 className="mt-12 text-3xl font-hairline text-gray-600 leading-none">{children}</h2>,
  h3: ({ children }) => <h3 className="text-xl font-hairline text-gray-600 leading-none">{children}</h3>,
  pre: ({ children }) => <pre className="my-12 block">{children}</pre>,
          ...
          <div className="overflow-hidden text-white" css={{ background: 'linear-gradient(to right, #9553e9, #6d74ed)' }}>
            <div className="max-w-6xl mx-auto relative">
              ...
              <header className="py-12 relative z-20 flex justify-between">
                <svg className="fill-current text-white h-6" viewBox="0 0 637.4 50.48">
                ...
                <div className="flex items-center text-white">
                  <a className="block flex items-center hover:text-pink-400 mr-5" href="https://github.com/inertiajs">
                  ...
                  <a className="block flex items-center hover:text-pink-400 mr-5" href="https://twitter.com/inertiajs">
                  ...
                  <a className="block flex items-center hover:text-pink-400" href="https://discord.gg/gwgxN8Y">
              ...
              { this.props.meta.hero &&
                <div className="mt-16 relative z-20 flex items-start">
                  <div className="w-1/2 mt-4">
                      <h1 className="text-5xl leading-tight font-light">
                        Build single-page apps that <strong className="font-bold">don’t require an API.</strong>
                      </h1>
                      <p className="mt-6 text-lg leading-relaxed font-medium max-w-md">
                  ...
                  <div className="w-1/2 pl-24">
                    <div className="px-4 pt-4 rounded-t flex" css={{ background: '#303f6d' }}>
                        <button onClick={(e) => this.setState(state => ({ tab: 'php' }))} type="button" className="focus:outline-none text-xs text-gray-500 hover:text-gray-200 font-medium px-6 pt-3 pb-2 rounded-t mr-1" css={ this.state.tab === 'php' ? { color: 'white', background: '#202e59' } : {}}>UsersController.php</button>
                        <button onClick={(e) => this.setState(state => ({ tab: 'vue' }))} type="button" className="focus:outline-none text-xs text-gray-500 hover:text-gray-200 font-medium px-6 pt-3 pb-2 rounded-t" css={ this.state.tab === 'vue' ? { color: 'white', background: '#202e59' } : {}}>Users.vue</button>
                    </div>
                    { this.state.tab === 'php' &&
                      <Code className="language-php" height={320}>{`class UsersController
{
    public function index()
    {
        ...
        return Inertia::render('Users', [
            'users' => $users
                    ...
                    { this.state.tab === 'vue' &&
                      <Code className="language-html" height={320}>{`<layout title="Users">
  <h1>Users</h1>
  <table>
    <tr>
      <th>Name</th>
    ...
    users: Object,
          ...
          <div className="max-w-6xl mx-auto flex py-24">
            <nav className="w-64 flex-shrink-0">
              <div className="text-xs font-bold uppercase text-gray-500 tracking-widest">Core</div>
              <ul className="mt-4">
                <li className="my-3"><Link href="/"><a className="hover:underline">Introduction</a></Link></li>
                <li className="my-3"><Link href="/how-it-works"><a className="hover:underline">How it works</a></Link></li>
                <li className="my-3"><Link href="/installation"><a className="hover:underline">Installation</a></Link></li>
                <li className="my-3"><Link href="/making-visits"><a className="hover:underline">Making visits</a></Link></li>
                <li className="my-3"><Link href="/sharing-data"><a className="hover:underline">Sharing data</a></Link></li>
                <li className="my-3"><Link href="/asset-refreshing"><a className="hover:underline">Asset refreshing</a></Link></li>
                <li className="my-3"><Link href="/local-state-caching"><a className="hover:underline">Local state caching</a></Link></li>
              </ul>
              <div className="mt-12 text-xs font-bold uppercase text-gray-500 tracking-widest">JS Adapters</div>
              <ul className="mt-4">
                <li className="my-3"><Link href="/react"><a className="hover:underline">React</a></Link></li>
                <li className="my-3"><Link href="/svelte"><a className="hover:underline">Svelte</a></Link></li>
                <li className="my-3"><Link href="/vue"><a className="hover:underline">Vue.js</a></Link></li>
              </ul>
              <div className="mt-12 text-xs font-bold uppercase text-gray-500 tracking-widest">Server Adapters</div>
              <ul className="mt-4">
                <li className="my-3"><Link href="/django"><a className="hover:underline">Django</a></Link></li>
                <li className="my-3"><Link href="/laravel"><a className="hover:underline">Laravel</a></Link></li>
                <li className="my-3"><Link href="/phoenix"><a className="hover:underline">Phoenix</a></Link></li>
                <li className="my-3"><Link href="/ruby-on-rails"><a className="hover:underline">Ruby on Rails</a></Link></li>
              </ul>
            </nav>
            <div className="leading-relaxed" css={{ '> * + *': { marginTop: '1.5rem' }, '> h2 + h3': { marginTop: '1.5rem' } }}>
              <MDXProvider components={components} children={this.props.children} />
            </div>
          </div>
        </div>
      )
