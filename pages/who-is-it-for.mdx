...
But what happens when these developers want to replace their server-side rendered views with a modern JavaScript-based single-page app front-end? The answer always is "you need to build an API". Because that's how modern SPAs are built.
