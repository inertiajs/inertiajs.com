...
<Notice>Be sure to use this feature sparingly, since shared data will be included with every Inertia response.</Notice>
  ...
  examples={[
    ...
    },
    {
      ...
      code: dedent`
        ...
        <main>
          <header>
            You are logged in as: {$pageProps.user.name}\n
            <nav>
              <InertiaLink href="/">Home</InertiaLink>
              <InertiaLink href="/about">About</InertiaLink>
              <InertiaLink href="/contact">Contact</InertiaLink>
