...
The server-side adapters provide a way to preassign shared data within each request. This is typically done outside of your controllers. Shared data will be automatically merged with the page props provided in your controller.
