...
To create links within an Inertia app you'll need to use the Inertia link component. They are a simple wrapper around a standard anchor link that intercept click events, and prevent a full page reload from occurring. This is how Inertia provides a single-page app experience.
