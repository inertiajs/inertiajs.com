...
- Updates the library to use the improved `finish` event handling in `@inertiajs/inertia` version [0.6.0](https://github.com/inertiajs/inertia/releases/tag/v0.6.0).
