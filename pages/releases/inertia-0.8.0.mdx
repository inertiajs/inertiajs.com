...
Note that your server-side adapter must also support this feature in order for this to work. The Laravel adapter has already been updated to support this, so be sure to upgrade to [version 0.3.5](https://github.com/inertiajs/inertia-laravel/releases/tag/0.3.5).
