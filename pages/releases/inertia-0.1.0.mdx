...
If you are currently using the `inertiajs/inertia-laravel` adapter, be sure to set your version to `^0.1`. This library has now been tagged as well. Note, there were some breaking changes made recently to how `Inertia::share()` works. See the [docs](https://github.com/inertiajs/inertia-laravel#sharing-data) for more information.
