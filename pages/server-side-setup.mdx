...
While not required, it's highly recommended that you also configure automatic asset refreshing. To do this you simply need to tell Inertia what the current version of your assets is.
...
See the [asset versioning](/asset-versioning) page for more information.
...
See the [responses](/responses) page for more information.
