...
In your controller, provide both the name of the JavaScript page component, as well as any props (data) required for the page.
...
Inertia shares page data between the server and the client-side page components using a `page` object. This object includes the necessary information required to render the page component, update the history state, and track the application's asset version.
