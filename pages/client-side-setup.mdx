...
If you are using React or Svelte you need to import the components you want to use from their respective library. If you are using Vue then this is already handled in the initialization. 
See the <a href="/links">links</a> section on how to do this.
...
<Notice>
  The loading indicator is only shown if a request takes longer than 250ms. To test it locally, you'll need to force a
  request to take longer than this.
</Notice>

In the future we intend to give more control over the handling of the loading indicator. See this <a href="https://github.com/inertiajs/inertia/issues/9">issue</a> for more information.
