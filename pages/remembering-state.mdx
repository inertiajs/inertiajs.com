...
To mitigate this issue, you can tell Inertia what local component state to save in the browser history.
...
Now, whenever your local page component state changes, Inertia will automatically save this data to the history state, and will restore it on history navigation.
