...
Also, keep in mind that Inertia only needs to do server-side rendering for the _first page load_. From that point on, you're in "SSR mode", and you just get normal Inertia XHR responses back.
