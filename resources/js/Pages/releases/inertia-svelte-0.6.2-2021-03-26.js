...
export default release(
  <>
    ...
    <P>
      This release adds a new form helper to the Svelte adapter, similar to the existing form helpers in the Vue 2, Vue
      3 and React adapters. This was contributed by <A href="https://github.com/mariojankovic">@mariojankovic</A>. It is
      designed to help reduce the amount of boilerplate needed for typical forms. Here's how to use it:
    </P>
    <CodeBlock
      language="html"
      children={dedent`
