...
const Page = () => {
  return (
    <>
      ...
      />
      <P>
        When you register an event, Inertia automatically returns you a callback to unregister the event. Combined with
        a destroyed hook, you can do something like this to automatically unregister the event when you navigate to a
        different page.
      </P>
      <CodeBlock
        language="js"
      ...
      />
      <P>
        Some events support cancellation, allowing you to prevent Inertia's default behaviour. Just like native events,
        if only one event listener calls <Code>event.preventDefault()</Code>, the event will be cancelled. Here is a
        complete list of all the available events:
      </P>
      <table>
        <tr>
          <th>Name</th>
        ...
        <tr>
          ...
          <td>
            ...
            <Code>resolveComponent()</Code> callback. Will NOT fire for XHR requests that receive a response (even if
            they are 400/500 level responses).
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            ...
            These are considered "successful" page navigation events, useful for tracking analytics, and things like
            that.
          </td>
          <td>
            <Code>e.detail.page</Code>
      ...
      <P>
        ...
        <Code>then()</Code>, <Code>catch()</Code> or <Code>finally()</Code> on an Inertia visit, you'll get the
        following warning:
      </P>
      <CodeBlock
        children={dedent`
