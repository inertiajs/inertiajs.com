  ...
  return (
    <>
      ...
      <Ul>
        ...
        <Li>
          Fixed bug with remembering array form values (
          <A href="https://github.com/inertiajs/inertia/issues/552">#552</A>),{' '}
          <A href="https://github.com/inertiajs/inertia/pull/575">#575</A>).
        </Li>
        <Li>
        ...
        <Li>
          Added Cypress test suite (<A href="https://github.com/inertiajs/inertia/pull/395">#395</A>).
        </Li>
      </Ul>
      ...
      <P>
        If you need to disable this behaviour, you can do that using the new <Code>remember</Code> form helper option
        (see below).
      </P>
