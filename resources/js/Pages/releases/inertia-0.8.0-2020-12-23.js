...
const Page = () => {
  return (
    <>
      ...
      <P>
        Inertia now handles this all for you automatically. Simply pass your data as an object, and Inertia will detect
        if any files are present (even nested files), and it will automatically convert the data to a{' '}
      ...
      <P>
        ...
        property. This can be customized using a new (optional) <Code>resolveErrors</Code> setting, applied at the
        adapter level.
      </P>
      <CodeBlock
        language="js"
      ...
      <P>
        ...
        <Code>error</Code> event for validation errors, and the previous global <Code>error</Code> event has been
        renamed to <Code>exception</Code>, which in hindsight is a more appropriate name anyway.
      </P>
      <P>
        Finally, we've added a new <Code>errorBag</Code> option when making Inertia visits. The purpose of this feature
        is to allow you to automatically scope the validation errors returned from the server within a key you specify.
        For example, instead of getting <Code>$page.props.errors</Code>, you can get{' '}
