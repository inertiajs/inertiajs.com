...
export default release(
  <>
    ...
    <P>
      This release adds support for persistent layouts (#203). Page components can now declare a persistent layout from
      inside the <Code>{'<script context="module">'}</Code> block:
    </P>
    <CodeBlock
      language="svelte"
      children={dedent`
