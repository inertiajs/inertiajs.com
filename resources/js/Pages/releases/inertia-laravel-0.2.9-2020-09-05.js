...
const Page = () => {
  return (
    <>
      ...
      <P>
        This update also supports named error bags, which are automatically scoped using the error bag name. For
        example:
      </P>
      <CodeBlock
        language="js"
      ...
      />
      <P>
        Named error bags are useful when you have multiple forms on the same page, and need a way to differentiate
        between the errors for one form and another. Also, coming is Laravel 8 is the ability to define error bags
        client-side (
