  ...
  return (
    <>
      ...
      <P>
        ...
        forcing a full page reload. This is done using the <Code>{`<Link>`}</Code> component, a light wrapper around a
        normal anchor link. When you click an Inertia link, Inertia intercepts the click and makes the visit via XHR
        instead. Worth noting, you can also make these visits programmatically in JavaScript using{' '}
