    ...
    <>
      ...
      <div className="mt-6">
        ...
        <P>
          ...
          use Inertia, please consider becoming one of our official sponsors. Any little bit helps!
        </P>
        <P>
          By becoming a sponsor, you'll help ensure the future success of this project. We'll also give you a public
          shoutout on Twitter, and will list you with our other sponsors above.
        </P>
      ...
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        ...
        <div className="mt-4 text-sm leading-normal">
          Aryeo is a leading visual data management system for the real estate industry. A platform for content
          creators, marketers, real estate agents, and brokerages to host, distribute, and collaborate on the visual
      ...
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        ...
        <div className="mt-4 text-sm leading-normal">
          Australia's centralised plant hire equipment, suppliers and services database for Plant Users and Project
          Managers managing earthworks projects in mining and civil.
        </div>
      </div>
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        ...
        <div className="mt-4 text-sm leading-normal">
          Ploi makes deploying a piece of cake. Ploi takes all the difficult work out of your hands, so you can focus on
          doing what you love: developing your application.
        </div>
      </div>
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        <div className="absolute top-0 right-0 px-4 py-2 bg-yellow-500 text-sm font-bold text-white rounded-bl">
      ...
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        ...
        <div className="mt-4 text-sm leading-normal">
          INDIGIT is devoted to creating tailored websites, web design, digital marketing, web and dedicated hosting.
          Passion and commitment is what we put into our services, relying on cutting-edge technologies.
        </div>
      </div>
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        <div className="absolute top-0 right-0 px-4 py-2 bg-yellow-500 text-sm font-bold text-white rounded-bl">
        ...
        <div className="mt-4 text-sm leading-normal">
          ...
          pinpoint and resolve performance issues before the customer ever sees them. Scout APM streamlines proactive
          and real-time insight, via easy package installation, into performance issues like N+1 queries, memory bloat,
          and other abnormalities with tracing logic that ties bottlenecks to source code.
        </div>
      </div>
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        <div className="absolute top-0 right-0 px-4 py-2 bg-yellow-500 text-sm font-bold text-white rounded-bl">
      ...
      <div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
        ...
        <div className="mt-4 text-sm leading-normal">
          Visually design and code Vue apps solo or with your team. Includes realtime designer/developer collaboration,
      ...
      <P>We are so grateful for our community sponsors! Thank you!</P>
            ...
            <div className="rounded flex items-center">
              ...
              <div className="pl-4 leading-none">
                ...
                <div className="mt-2 text-sm text-gray-600">
                  Sponsor since{' '}
                  {new Date(sponsor.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'short' })}
                </div>
              </div>
            </div>
          </div>
