    ...
    return (
      <div className="bg-gray-200">
        <div className="mx-auto flex max-w-6xl items-center justify-start overflow-x-auto px-6 py-4 md:px-12 xl:px-0">
          <div className="text-md mr-6 font-medium text-gray-600">
            <div className="md:hidden">Sponsors:</div>
            <div className="hidden whitespace-nowrap md:block">Our sponsors:</div>
          </div>
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://forge.laravel.com" title="Laravel Forge">
          ...
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://ploi.io" title="Ploi">
          ...
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://contestkit.com" title="ContestKit">
            <svg className="h-4 w-auto fill-current" viewBox="0 0 244 132">
          ...
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://brook.io" title="Brook">
            <svg className="h-5 w-auto fill-current" viewBox="0 0 216.01 66.49">
              <path
                fill="#edf2f7"
          ...
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://laracasts.com" title="Laracasts">
          ...
          <a className="mr-12 text-gray-600 hover:text-gray-800" href="https://loadforge.com" title="LoadForge">
            <svg className="h-4 w-auto fill-current" viewBox="0 0 256 36" fill="none">
  ...
  return (
    <>
      ...
      <div onClick={() => setShowMobileNav(false)} className="font-sans leading-none text-gray-800 antialiased">
        <div className="text-md flex items-center justify-center bg-[#fde9b1] px-6 py-4 font-medium md:px-12 xl:px-0">
          ...
          <a
            ...
            className="ml-2 whitespace-nowrap rounded-full bg-orange-500 px-3 py-1 text-xs leading-tight text-white hover:bg-orange-600"
          >
            Legacy docs
          </a>
        </div>
