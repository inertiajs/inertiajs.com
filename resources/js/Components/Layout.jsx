    ...
    return (
      <div className="bg-gray-200">
        <div className="mx-auto flex max-w-6xl items-center justify-start gap-8 overflow-x-auto px-6 py-4 md:px-12 lg:gap-12 xl:px-0">
          ...
          <a className="text-gray-600 hover:text-gray-800" href="https://www.activitysource.com" title="ActivitySource">
          ...
          <a className="text-gray-600 hover:text-gray-800" href="https://www.peakcrypto.com" title="Peak Crypto">
