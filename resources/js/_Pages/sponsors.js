...
<div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
  <div className="absolute top-0 right-0 px-4 py-2 bg-red-600 text-sm font-bold text-white rounded-bl">Partner</div>
...
<div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
  <div className="absolute top-0 right-0 px-4 py-2 bg-red-600 text-sm font-bold text-white rounded-bl">Partner</div>
  <a className="inline-flex" href="https://www.iseekplant.com.au" title="iSeekplant.com.au">
    <svg className="w-auto h-10" viewBox="0 0 524.5 185.1">
  ...
  <div className="mt-4 text-sm leading-normal">
    Australia's centralised plant hire equipment, suppliers and services database for Plant Users and Project Managers
    managing earthworks projects in mining and civil.
  </div>
</div>

<div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
  <div className="absolute top-0 right-0 px-4 py-2 bg-yellow-500 text-sm font-bold text-white rounded-bl">Business</div>
...
<div className="mt-8 p-8 shadow rounded relative overflow-hidden leading-none max-w-md">
  ...
  <div className="mt-4 text-sm leading-normal">
    Push your web development skills to the next level, through expert screencasts on Laravel, Vue, and so much more.
  </div>
</div>
...
<div className="mt-12 flex flex-wrap -ml-4">
  {sponsors.data.user.sponsorshipsAsMaintainer.edges.map(({ node: sponsor }) => (
    <div key={sponsor.sponsorEntity.login} className="w-full md:w-1/2 pl-4 pb-4">
      <div className="rounded flex items-center">
        <a href={`https://github.com/${sponsor.sponsorEntity.login}`}>
          <img
        ...
        <div className="pl-4 leading-none">
          <a href={`https://github.com/${sponsor.sponsorEntity.login}`} className="text-base font-bold text-gray-700">
            {sponsor.sponsorEntity.login}
          </a>
          <div className="mt-2 text-sm text-gray-600">
            Sponsor since {new Date(sponsor.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'short' })}
          </div>
        </div>
      </div>
    </div>
